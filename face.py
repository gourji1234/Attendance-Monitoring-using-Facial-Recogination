...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'sakshijhala07@gmail.com' ")

########################################################################################################

def check_haarcascadefile():
    exists = os.path.isfile("E:\\IBM Industrial Tranning\\haarcascade_frontalface_default (1).xml")
    if exists:
        pass
    else:
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = ("E:\IBM Industrial Tranning\haarcascade_frontalface_default (1).xml")
        detector = cv2.CascadeClassifier("E:\IBM Industrial Tranning\haarcascade_frontalface_default (1).xml")
        sampleNum = 0
        while (True):
            ret, img = cam.read()
...
def TrackImages():
    ...
    if exists3:
        ...
        return
    harcascadePath = ("E:\IBM Industrial Tranning\haarcascade_frontalface_default (1).xml")
    faceCascade = cv2.CascadeClassifier("E:\IBM Industrial Tranning\haarcascade_frontalface_default (1).xml")
